 ...
 * MLab:
 * mongo mongodb://user:pwd@xxx.mlabl.com:33533/issuetracker scripts/init.mongo.js
 *
 */
...
const issuesDB = [
  {
    ...
    description: 'Steps to recreate the problem:'
      ...
      + '\n will not be aded to the history stack'
      + '\n4. Click on Add.'
...
// Add counters collection to the db for issue
// in order to generate sequence of unique numbers when called
